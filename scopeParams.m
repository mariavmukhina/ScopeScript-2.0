classdef scopeParams < matlab.mixin.SetGet & handle
    properties
        ...
        timePoints1  = 0:60*15:60*60*16; % start immediately, call function[1] every 10 sec for 60 sec total
        exposure1 = 10;
        ...
        setChannel6  = {{'laser-561-640',{1,1}}};
        function6    = {'takeA3DStack',{'zStack4','Laser561&640'},''};
        timePoints6  = 0:10:60;
        exposure6    = 10;
        

        setChannel7  = {{'laser-640',1},{'laser-488',1}};
        function7    = {'takeA3DStack',{'zStack1','Laser640TTL','zStack2','Laser488TTL'},''};
        timePoints7  = 0:60*15:60*60*16;
        exposure7    = 20;
